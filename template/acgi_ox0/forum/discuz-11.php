...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
	...
	<!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]-->
		...
		<div class="acgiFone" styles="display:none;">
			<div class="acgiFoneL">
				<!--[diy=acgiFoneL]--><div id="acgiFoneL" class="area"></div><!--[/diy]-->
			</div>
			<div class="acgiFoneR">
				<div class="acgiFoneRtabs">
					<ul class="acgiFoneRtabname">
						<li class="cur btntab">COS</li>
						<li class="btntab">GAL·RPG</li>
						<li class="btntab">福利视频</li>
                                                <li class="btntab">图包</li>
                                                <li class="btntab">漫画</li>
                                                <li class="btntab">音乐</li>
                                                <li class="btntab">热门</li>
						<li class="btntab">赚积分活动</li>
						<div class="clear"></div>
					</ul>
					<div class="clear"></div>
					<ul class="acgiFoneRtab">
						<li style="display:block;"><dl><!--[diy=acgiFoneRtab1]--><div id="acgiFoneRtab1" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=acgiFoneRtab2]--><div id="acgiFoneRtab2" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=acgiFoneRtab3]--><div id="acgiFoneRtab3" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=acgiFoneRtab4]--><div id="acgiFoneRtab4" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=acgiFoneRtab5]--><div id="acgiFoneRtab5" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=acgiFoneRtab6]--><div id="acgiFoneRtab6" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=acgiFoneRtab7]--><div id="acgiFoneRtab7" class="area"></div><!--[/diy]--></dl></li>
					<li><dl><!--[diy=acgiFoneRtab8]--><div id="acgiFoneRtab8" class="area"></div><!--[/diy]--></dl></li>
					</ul>
             ...
             <div class="RanlistFourmArea">
				<div class="RanlistFourmAreabs">
					<ul class="RanlistFourmAreaName">
						<li class="cur btntab">活动排行</li>
						<li class="btntab">积分排行</li>
						<div class="clear"></div>
					</ul>
					<div class="clear"></div>
					<ul class="RanlistFourm">
						<li style="display:block;"><dl><!--[diy=RanlistFourm1]--><div id="RanlistFourm1" class="area"></div><!--[/diy]--></dl></li>
						<li><dl><!--[diy=RanlistFourm2]--><div id="RanlistFourm2" class="area"></div><!--[/diy]--></dl></li>
					</ul>
					<script type="text/javascript">
						jq(".RanlistFourmAreaName li").each(function(s){
							jq(this).click(function(){
								jq(this).addClass("cur").siblings().removeClass("cur");
								jq(".RanlistFourm li").eq(s).show().siblings().hide();
								})
							})
					</script>
				</div>
	...
	<div class="mn">
					...
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{loop $collectiondata['follows'] $key $colletion}-->
							...
							<td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
								<div class="fl_icn_g">
								<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank"><img src="$_G['style'][styleimgdir]/forum{if $followcollections[$key]['lastvisit'] < $colletion['lastupdate']}_new{/if}.png" alt="$colletion[name]" /></a>
								</div>
								<dl>
							...
							<td class="fl_g" width="$cat[forumcolwidth]">
								<!--{if $cat['forumcolumns'] > 2}-->
									<div class="fl_icn_gex">
										<h3><a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>$forum[name]</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1" title="{lang forum_todayposts}"> ($forum[todayposts])</em><!--{/if}--></h3>
										<span class="desc">
											<!--{if $forum[icon]}-->
												$forum[icon]
											<!--{else}-->
											...
											<!--{if !empty($forum[description])}-->
												<div class="des">
													<span class="desccur"></span><!--{echo dnumber($forum[description])}-->
												</div>
											<!--{/if}-->
										</span>
										<div class="fl_info">
										...
										<!--{else}-->
											...
											<!--{elseif is_array($forum['lastpost'])}-->
												<!--{if $cat['forumcolumns'] < 3}-->
													<p><a href="forum.php?mod=redirect&tid=$forum[lastpost][tid]&goto=lastpost#lastpost" class="xi2"><!--{echo cutstr($forum[lastpost][subject], 36)}--></a></p>
							...
							<td class="fl_by">
								...
								<!--{else}-->
									<!--{if $forum['redirect']}-->
										<a href="$forumurl" class="xi2">{lang url_link}</a>
									<!--{elseif is_array($forum['lastpost'])}-->
										<p><a href="forum.php?mod=redirect&tid=$forum[lastpost][tid]&goto=lastpost#lastpost" class="xi2"><!--{echo cutstr($forum[lastpost][subject], 30)}--></a></p>
										<cite>$forum[lastpost][dateline] <!--{if $forum['lastpost']['author']}-->$forum['lastpost']['author']<!--{else}-->$_G[setting][anonymoustext]<!--{/if}--></cite>
									<!--{else}-->
										{lang never}
									<!--{/if}-->
				...
				<div id="category_-2" class="bm_c" style="{echo $collapse['category_-2']}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{loop $collectiondata['data'] $key $colletion}-->
							...
							<td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
								<div class="fl_icn_g">
								<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank"><img src="$_G['style'][styleimgdir]/forum.png" alt="$colletion[name]" /></a>
								</div>
								<dl>
									<dt><a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}">$colletion[name]</a></dt>
									<dd><em>{lang forum_threads}: <!--{echo dnumber($colletion[threadnum])}--></em>, <em>{lang collection_commentnum}: <!--{echo dnumber($colletion[commentnum])}--></em></dd>
		...
		<!--{if empty($gid) && $_G['setting']['whosonlinestatus']}-->
			<div id="online" class="bm oll" {if !$detailstatus}style="border-bottom:0;"{/if}>
				<div class="bm_h">
				<!--{if $detailstatus}-->
		...
		<div id="sd" class="sd">
			<div class="acgiFsd">
				<div class="acgiFsdo">
					<!--{hook/index_side_top}-->
					<div class="Fsdtop">
						<!--[diy=Fsdtop]--><div id="Fsdtop" class="area"></div><!--[/diy]-->
					</div>
				</div>
				<div class="acgiFsdo">
					<div class="acgipartr">
						...
						<div class="acgitabc">
							<dl>
								<dd style="display:block;"><!--[diy=Ftab1]--><div id="Ftab1" class="area"></div><!--[/diy]--><div class="clear"></div></dd>
								<dd><!--[diy=Ftab2]--><div id="Ftab2" class="area"></div><!--[/diy]--><div class="clear"></div></dd>
							</dl>
						</div>
					</div>
				</div>
