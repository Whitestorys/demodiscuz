...
<!--{if CURMODULE == 'logging'}-->
	<div class="acheader">
		<div class="lg_header">
			<a href="./" style="margin-top:5px;" class="logo acduang">{$_G['style']['boardlogo']}</a>
		</div>
	</div>
<!--{else}-->
		<div class="actoptb">
			...
			<div class="wp1220">
				...
				<div class="row-r b"><!--{template common/header_m_top}--></div>
				<div class="clear"></div>
			</div>
		</div>
		<div class="achead">
			<div class="acheadmask">
				<div class="achdc">
					<a href="./" style="margin-top:5px;" class="logo acduang">{$_G['style']['boardlogo']}</a><!--margin-top&#x8C03;&#x6574;logo&#x4F4D;&#x7F6E;-->
					<div class="acPsearch">
		...
		<div class="acnv">
			<div class="wp1220">
				<div id="nv">
					<a href="javascript:;" id="qmenu" title="&#x70B9;&#x51FB;" onClick="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu($_G[fid]);})">{lang my_nav}</a>
					<ul>
		...
		<!--$_G['setting']['disfixednv_forumindex']-->
			<div id="acsubnav">
			...
			<div class="wp1220">
				...
				<!--{if $_G['setting']['subnavs']}-->
					<!--{loop $_G[setting][subnavs] $navid $subnav}-->
						...
						<ul class="cl" id="snav_$navid" style="display:none;">
						$subnav
						</ul>
						<!--{/if}-->
					<!--{/loop}-->
